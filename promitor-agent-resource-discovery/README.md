...
| `secrets.secretName`  | Name of the secret for Azure AD identity secret  | `""`            |
| `secrets.appKeySecret`  | Name of the secret key for Azure AD identity secret | `azure-app-key`            |
